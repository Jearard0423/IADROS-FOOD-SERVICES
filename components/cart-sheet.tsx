  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-lg flex flex-col p-0 h-full">
        <SheetHeader className="p-4 sm:p-6 pb-4 flex-shrink-0">
        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="border-t border-border p-4 sm:p-6 space-y-4 bg-muted/30 flex-shrink-0">
              ...
              <Button className="w-full h-12 text-base font-semibold" onClick={onCheckout} size="lg">
                Proceed to Checkout
              </Button>
            </div>
          </>
